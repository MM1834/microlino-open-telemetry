...
- Select Standard-CAN V1 - Pioneer / Gen1 Mid-Range for confirmed
  first-generation Pioneer or Mid-Range installations. Standard-CAN V2 has an independent pilot decoder and may be used
  only for a controlled V2 validation; its current scale, power sign and
  plug/charge interpretation remain provisional until compared with independent
